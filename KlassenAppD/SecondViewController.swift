...
class SecondViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if Auth.auth().currentUser != nil {
            menuButton.addMenuItems([item00, item0, item2, item3, item4, item5, item6, item7, item8, item9])
        }
        else {
            menuButton.addMenuItems([item00, item0, item2, item3, item4, item5, item6, item7, item9])
        }
        if UserDefaults.standard.integer(forKey: "DarkmodeStatus") == 1 {
