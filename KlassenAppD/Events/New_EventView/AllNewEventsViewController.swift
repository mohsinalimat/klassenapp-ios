//
//  AllNewEventsViewController.swift
//  KlassenAppD
//
...
class AllNewEventsViewController: UIViewController {
    ...
    @objc func reloadData() {
        ...
        ref.child("arbeiten").child("list").child(TestVC.selectedEventID).child("name").observe(.value) { datesnap in
